...
class Hand:
    ...
    def process(self):
        ...
        while cap.isOpened():
            ...
            # 处理一只手
            hand_landmarks = multi_hand_landmarks
            left_landmark = hand_landmarks[0].landmark
            ...
            landmark_style = mp.solutions.drawing_util.DrawingSpec(color=(0, 0, 0))
            line_style = mp.solutions.drawing_util.DrawingSpec(color=(224, 224, 224))
            mp.solutions.drawing_utils.draw_landmarks(frame, left_landmark, conn, connections=conn)
